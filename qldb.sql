...
INSERT INTO `courses` VALUES (2, 1,1,'Học lập trình html','course1.jpg','<div class="singel-description pt-40"><h6>Những gì bạn sẽ học?</h6></div><div>&nbsp;&nbsp;-&nbsp; Tạo chương trình trong C</div><div>&nbsp;&nbsp;-&nbsp; Hiểu kiến ​​thức cơ bản về lập trình (cách tạo phần mềm từ mã nguồn).</div><div>&nbsp;&nbsp;-&nbsp; Sử dụng thư viện C tiêu chuẩn (STL).</div><div>&nbsp;&nbsp;-&nbsp; Nắm vững việc quản lý các biến và bộ nhớ.</div><div>&nbsp;&nbsp;-&nbsp; Nắm vững việc sử dụng các vòng lặp và điều kiện.</div><div>&nbsp;&nbsp;-&nbsp; Mảng chính và con trỏ.</div><div>&nbsp;&nbsp;-&nbsp; Tạo và sử dụng các chức năng.</div><div>&nbsp;&nbsp;-&nbsp; Tạo mô-đun để chia sẻ chúng.</div>',5.9,0,4.7,52,53,'2020/12/12',11,1);
